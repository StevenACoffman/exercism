...
class WordCountTests(unittest.TestCase):
    ...
    def test_include_numbers(self):
        self.assertEqual({'testing': 2,
                          '1': 1,
                          '2': 1}, word_count('testing 1 2 testing'))
    ...
    def test_newlines(self):
        self.assertEqual(
            {'rah': 2,
             ...
             'your': 1,
             'bad': 1,
             'romance': 1}, word_count('rah rah ah ah ah\nroma roma ma\n'
    ...
    def test_unicode(self):
        self.assertEqual(
            {decode_if_needed('до'): 1,
             decode_if_needed('свидания'): 1}, word_count('до🖖свидания!'))
